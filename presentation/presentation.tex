...
\begin{frame}%{Study 1: Localized Ear Temperature Measurement Study Procedure: Baseline Surveys and Environmental Influences}
    \includegraphics[width=0.95\linewidth]{../thesis-doc/images/study1/Procedure.pdf} % Right image, full column width
\end{frame}

\section{Study 2}
\begin{frame}%{Study 2: Study Course Under Stress Conditions: Impact on Temperature Measurements With Ear-Based Sensors}
    \includegraphics[width=0.95\linewidth]{../thesis-doc/images/study2/Procedure2.pdf} % Right image, full column width
\end{frame}
