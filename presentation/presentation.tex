...
\begin{frame}{Prototype}
  \begin{columns}[T] % The "T" option aligns column content to the top
    ...
    \begin{column}{.31\textwidth} % Right column, 48% of the text block width
      \includegraphics[width=0.9\linewidth]{../thesis-doc/images/prototype/Earpod_Front.png} % Right image, full column width
    \end{column}
...
\begin{frame}%{Study 1: Localized Ear Temperature Measurement Study Procedure: Baseline Surveys and Environmental Influences}
    \includegraphics[width=0.95\linewidth]{../thesis-doc/images/study1/Procedure_short.pdf} % Right image, full column width
\end{frame}

\section{Study 2}
\begin{frame}%{Study 2: Study Course Under Stress Conditions: Impact on Temperature Measurements With Ear-Based Sensors}
    \includegraphics[width=0.95\linewidth]{../thesis-doc/images/study2/Procedure2_short.pdf} % Right image, full column width
\end{frame}
