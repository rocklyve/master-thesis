...
However, the most commonly used measurement point on the ear for temperature is the eardrum. 
...
Body temperature is significantly lower at night than during the day, even nearly $1 ^\circ C$ difference at peak.
...
% TODO: die hier noch machen!
% \cite{bestbierDevelopmentVitalSigns2018}
% \cite{luekenPhotoplethysmographybasedInearSensor2017}
% \cite{matsumotoEarbudtypeWearableHearable2019}
% \cite{chagllae.MeasurementCoreBody2018}
% \cite{chenInearThermometerWearable2020}
