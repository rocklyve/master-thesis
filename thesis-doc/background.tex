...
Usually, core body temperature is constant only in the body core.
Due to this, it is necessary to use several other values for the calculation of the core body temperature \cite{niedermannPredictionHumanCore2014}. 
These include e.g. skin temperature and skin heat fluxes or the heart rate.
