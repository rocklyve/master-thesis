...
The last part of the physiological parameters and health is the thermal regulation. A distinction is made here between body temperature and perspiration. An EDA (electrodermal activity) and a hygrometer are used for sweating.
When classifying body temperature, an infrared thermometer and a thermistor are used.
Due to the body temperature being the most crucial part in this thesis, this part will now be focused in more detail.
...
For individual calibration purposes, the voltage difference of the thermopile element and the chip temperature were transmitted in addition to the recorded object temperature.
