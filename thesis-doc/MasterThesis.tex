...
% \usepackage{verbatim}
\usepackage{float} 
\usepackage{enumitem}%z.B. \floatstyle{ruled}\restylefloat{figure}
...
\pagenumbering{roman}
\ifnotdraft{
 \includepdf{images/titlepage.pdf}
...
\include{design_and_analysis}     % Entwurf
