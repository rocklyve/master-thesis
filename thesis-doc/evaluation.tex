...
In the first perspective, the data were considered when the subject was seated (Phase 2). 
...
In order to detect stress fundamentally for the first time, HRV measurement with the Polar H9 is performed in parallel.
This will be used to initially test whether subjects were actually experiencing stress during the study in phase 3 by looking at the HRV signal and classifying the stress.
Then hypotheses are tested and proven or disproven.
...
Here it can be seen that for Subject 1, the SDNN and RMSSD value decreased during the stress phase, which is an indication of stress.
...
\begin{figure}[t]
    ...
    \begin{subtable}{\textwidth}
        ...
        \begin{tabularx}{\textwidth}{|l|*{4}{>{\centering\arraybackslash}X|}}
            \hline
            \textbf{Sensor} & \multicolumn{2}{c|}{\textbf{Sitting - Stress}} & \multicolumn{2}{c|}{\textbf{Stress - Relax}} \\
            & \textbf{All} & \textbf{1,4,5} & \textbf{All} & \textbf{1,4,5} \\
            & \textbf{p-value} & \textbf{p-value} & \textbf{p-value} & \textbf{p-value} \\
            \hline
            \textbf{Tympanic Membrane} & 0.049 & 0.007 & 0.387 & 0.530 \\
            \textbf{Concha} & 0.095 & 0.442 & 0.553 & 0.831 \\
            \textbf{Ear Canal} & 0.504 & 0.098 & 0.568 & 0.733 \\
            \textbf{Outer Ear Bottom} & 0.009 & 0.113 & 0.680 & 0.479 \\
            \textbf{Outer Ear Top} & 0.005 & 0.086 & 0.689 & 0.201 \\
            \textbf{Outer Ear Middle} & 0.029 & 0.077 & 0.616 & 0.073 \\
            \hline
        \end{tabularx}%
        }
        \caption{t-Test results for different sensors across phases for all subjects and for subjects 1,4 and 5. The p-value for transitions between Sitting - Stress and Stress - Relax are presented.}
...
The mean temperature of all subjects (minus ground truth) for all subjects as well as for subjects 1,4 and 5 during the three relevant phases can be seen. 
